...
public class SteamVR_FirstPersonController : MonoBehaviour
{
    ...
    private string test4 = "Controller";
    ...
    void UpdateGrabbableObjects()
    {
        ...
        {
            if (test4 == "Controller" && device.GetTouchDown(SteamVR_Controller.ButtonMask.Trigger))
            {
            ...
            else if(test4 == "Sword" && device.GetTouchDown(SteamVR_Controller.ButtonMask.Trigger))
            {
